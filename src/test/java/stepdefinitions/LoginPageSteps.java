...
public class LoginPageSteps {
	...
	public void user_is_on_login_page() {	
		...
		//DriverFactory.getDriver().get("https://swgw-test.ericsson.net/");	
		String SWGW_URL = prop.getProperty("URL");
		DriverFactory.getDriver().get(SWGW_URL);
	...
	public void user_enters_username() {
		String username = prop.getProperty("SWGW_UserName");
	...
	public void user_enters_password() {
		String password = prop.getProperty("SWGW_PassWord");
